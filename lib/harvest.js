...
( function() {
	...
	harvest.saveBasket = function( sharedBasket, storedBasket ) {
		...
		var parentVersion = storedBasket.versions[sharedBasket.version].base;
		...
		storedBasket.versions[sharedBasket.version]['+'] = additions;
		storedBasket.versions[sharedBasket.version]['-'] = subtractions;
	};
